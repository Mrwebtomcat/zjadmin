...
<template>
	<section>
		...
		<el-table :data="Vipdata" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="dateM" label="星级月份"  sortable>
			</el-table-column>	
			<el-table-column prop="money" label="星级金额"  sortable>
			</el-table-column>
		...
		<el-dialog title="编辑" v-model="editFormVisible" :close-on-click-modal="false">
			<el-form :model="addForm" label-width="150px" :rules="addFormRules" ref="addForm">
				<el-form-item label="星级开通月数" prop="name">
					<el-input v-model="addForm.name" auto-complete="off"></el-input>
				</el-form-item>
				<el-form-item label="星级开通金额" prop="money">
...
<script>
	...
	import { getUserListPage, removeUser, batchRemoveUser, editUser, addUser,setVip ,getVipConfig} from '../../api/api';
